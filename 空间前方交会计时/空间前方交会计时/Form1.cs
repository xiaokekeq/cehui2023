...
namespace 空间前方交会计时
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("open error(empty) ", "open", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            a22 = -Math.Cos(cpt(fai2)) * Math.Sin(cpt(k2)) - Math.Sin(cpt(fai2)) * Math.Sin(cpt(w2)) * Math.Sin(cpt(k2));
        ...
        private void 计算空间辅助坐标ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void 计算地面坐标ToolStripMenuItem_Click(object sender, EventArgs e)
        {
