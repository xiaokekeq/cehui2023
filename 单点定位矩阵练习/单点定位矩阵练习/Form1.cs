    ...
    public partial class Form1 : Form
    {
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < parse.data_all.Count(); i++)
            {
                ...
                dataGridView1.Rows[m].Cells[0].Value = $"第{i+1}个数据";
                m++;
                for (int j = 0; j < parse.data_all[i].sate_cg.satNum; j++)
                {
                    dataGridView1.Rows.Add(1);
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < parse.data_all.Count(); i++)
            {
                ...
                dataGridView2.Rows[i].Cells[0].Value = parse.data_all[i].sate_cg.time;
                dataGridView2.Rows[i].Cells[1].Value = parse.pos.arr[0, 0].ToString("F4");
                dataGridView2.Rows[i].Cells[2].Value = parse.data_all[i].sigama.arr[0, 0].ToString("F4");
                dataGridView2.Rows[i].Cells[3].Value = parse.pos.arr[1, 0].ToString("F4");
                dataGridView2.Rows[i].Cells[4].Value = parse.data_all[i].sigama.arr[1, 0].ToString("F4");
                dataGridView2.Rows[i].Cells[5].Value = parse.pos.arr[2, 0].ToString("F4");
                dataGridView2.Rows[i].Cells[6].Value = parse.data_all[i].sigama.arr[2, 0].ToString("F4");
